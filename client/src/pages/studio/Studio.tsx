            ...
            {pillars.map((pillar) => (
              ...
              >
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <Link href={pillar.href} data-testid={`link-pillar-${pillar.id}`}>
                    <Button variant="ghost" size="sm" className="p-0 h-auto text-primary hover:text-primary/80" data-testid={`button-pillar-${pillar.id}`}>
