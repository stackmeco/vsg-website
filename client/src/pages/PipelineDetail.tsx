  ...
  return (
    <Layout>
      ...
      <section className="py-16 lg:py-20 relative overflow-hidden border-b border-border" data-testid="section-hero">
        ...
        />
        <div className="absolute inset-0 z-10 bg-gradient-to-r from-background via-background/90 to-background/70 pointer-events-none" aria-hidden="true" />
        <div className="absolute inset-0 z-10 bg-gradient-to-t from-background via-transparent to-background/50 pointer-events-none" aria-hidden="true" />
