...
export function ArticleAudioPlayer({ audioSrc, articleTitle }: ArticleAudioPlayerProps) {
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button 
          ...
          data-testid="button-article-audio"
        >
      ...
      <DialogContent 
        ...
        aria-modal="true"
      >
        <DialogTitle className="sr-only">{articleTitle} Audio Briefing</DialogTitle>
        <DialogDescription className="sr-only">
          Listen to the audio briefing for {articleTitle}. Use the play button to start playback.
        </DialogDescription>
        ...
        <div className="h-40 bg-background relative flex items-center justify-center">
          {hasError ? (
            ...
            <button 
              ...
              data-testid="button-article-play-pause"
