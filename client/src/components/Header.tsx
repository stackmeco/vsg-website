          ...
          <nav className="hidden lg:flex items-center gap-1" data-testid="nav-desktop" aria-label="Main navigation">
            {navItems.map((item) => (
              <Link 
                ...
                href={item.href}
                className={cn(
                  "px-3 py-2 text-[10px] font-mono uppercase tracking-widest transition-all duration-150 rounded-[2px] border border-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background",
                  isActive(item.href)
            ...
            <div className="flex items-center gap-4 ml-4">
              ...
              >
                ...
                <kbd className="pointer-events-none hidden sm:inline-flex h-5 select-none items-center gap-1 rounded-[2px] border border-border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">
